...
3. **Tab Thư tài liệu** có bộ field riêng, nhỏ gọn hơn, bám sát đúng `CreateLetterDrawer` — chi tiết đầy đủ xem [SHOP-ORDER-31](./cai-dat-thong-tin-mac-dinh-thu-tai-lieu.md).
...
**AC3:** Tab Thư tài liệu KHÔNG hiện: Ca lấy hàng, Kích thước đơn hàng, Khai giá trị hàng, Giao/Trả 1 phần, Giao thất bại thu tiền, Tự động yêu cầu giao lại, Phí ship, Thu ship khách hàng.

**AC4:** Tab Thư tài liệu có bộ field riêng — chi tiết từng field và hành vi tương tác xem SHOP-ORDER-31.
...
- Chi tiết đầy đủ sub-tab Thư tài liệu (từng field, hành vi tương tác, lịch sử quyết định về "Ghi chú xem hàng" là placeholder tĩnh) → [SHOP-ORDER-31](./cai-dat-thong-tin-mac-dinh-thu-tai-lieu.md).
- AC5 (mục "Trả hàng"): field "Địa chỉ trả hàng" là `SelectCtrl` tĩnh chưa implement — field áp dụng cho cả 2 loại đơn (đích đến đều là địa chỉ trả hàng đã đăng ký) nhưng mô tả chưa phân biệt rõ cơ chế giao chặng cuối (NVC giao thẳng vs đại lý giao lại) — chi tiết xem [SHOP-ORDER-36](./dia-chi-tra-hang-chua-implement-ap-dung-ca-2-loai-don.md).
