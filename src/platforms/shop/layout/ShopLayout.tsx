...
const SETTINGS_ITEM = { key: '/shop/settings', icon: <SettingOutlined />, label: 'Cài đặt' }
        ...
        >
          ...
          <div style={{ padding: '0 16px 4px' }}>
            {(() => {
              ...
              return (
                <div
                  onClick={() => navigate('/shop/document')}
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: 12,
          ...
          <div style={{ padding: '0 16px 10px', textAlign: 'center' }}>
            <span style={{ fontSize: 11, color: '#C4C4C4', letterSpacing: 0.3 }}>v0.23.0</span>
          </div>
        </aside>
