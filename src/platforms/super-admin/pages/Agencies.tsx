...
import {
  agenciesList, shopConnections, carrierRequests, clientHubs247, SERVICE_TYPES_247,
    ...
    return (
      <div style={{ padding: '12px 12px 10px', background: '#F5F3FF', borderTop: `1px solid #C4B5FD` }}>
        <div style={{ fontSize: 13, color: '#5B21B6', fontWeight: 600, marginBottom: 10 }}>
          Bước 1/2 — Chọn dịch vụ 247Express cho <span style={{ color: C_LINK }}>{agencyName}</span>
        </div>
